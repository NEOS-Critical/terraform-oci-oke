...
locals {
  ...
  bastion_subnet = var.create_bastion ? can(local.vcn_cidr_dmz) ? local.vcn_cidr_dmz : cidrsubnet(local.vcn_cidr_dmz, lookup(var.subnets["bastion"], "newbits"), lookup(var.subnets["bastion"], "netnum"))
